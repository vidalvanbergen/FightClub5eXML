@echo off
if "%1"=="" (
  echo "Usage: build-collections.bat path-to-collections/collection-file.xml path-to-utilities/merge.xslt [optional path-to-compendium-destination-directory]
